...
function KeyInputComponent({ onClick }) {
  ...
  return (
    <div className="buttons">
      ...
      <button className="num" name="9" onClick={(e) => onClick(e.target.name)}>
        9
      </button>
      <button
        className="operator right"
      ...
      <br />
      <button className="num" name="4" onClick={(e) => onClick(e.target.name)}>
        4
      </button>
      ...
      <br />
      <button className="num" name="1" onClick={(e) => onClick(e.target.name)}>
        1
      </button>
      <button className="num" name="2" onClick={(e) => onClick(e.target.name)}>
        2
      </button>
      <button className="num" name="3" onClick={(e) => onClick(e.target.name)}>
        3
      </button>
      <button
        className="operator right"
